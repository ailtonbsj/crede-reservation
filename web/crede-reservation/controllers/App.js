...
$App.generateMenu = function () {
	...
	// itemMenu.find('a').attr('data-module', 'Agenda').addClass('action-item-menu');
	// itemMenu.find('span').html('Agenda');
	// itemMenu.find('i').addClass('fa-calendar');
	...
	$('.action-item-menu').on('click', function (anchor) {
